$(document).ready(function() {
  ...
  function addPost() {    
    ...
    $('section').find('div:first').before('<div class="clearfix newsfeed-contact"><figure class= "col-xs-3 col-sm-2"> <img src="../assets/images/foto.jpg" class="img-circle contact" alt="Profile"></figure><h4 class="col-xs-4 col-sm-2">Designer</h4><span class="follow"><a href="#" data-toggle="tooltip" title="Seguir"><img src="../assets/images/addcontact.svg" alt="followers" class="icon-follow"></a></span><p class="col-xs-9 col-sm-10 text clearfix">' + $content + '</p><div class="container-icons col-xs-offset-3 col-xs-8 col-sm-offset-2 col-sm-9"><p class="time col-xs-1 col-sm-1">' + $time + '</p><div class="icons col-xs-offset-7 col-sm-offset-8"><span class="comment start-chat"><img src="../assets/images/chat.svg" alt="chat"></span><span><a href="#" data-toggle="tooltip" title="Me encanta"><img src="../assets/images/heart.svg" alt="heart"></a></span></div></div></div><hr>');
    createComment();
    addComments();
  }
